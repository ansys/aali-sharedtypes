...
type ClientRequest struct {
	...
	// Type of the request; can be "message", "get_variable_values", "set_variable_values", "keepalive", "take_snapshot", "load_snapshot", "get_slash_commands", "feedback", "get_conversation_title", "tool_validation", "code_execution", "parallel_code_execution", "edit_assitant_message", "set_chat_model", "approval_response"
...
type ClientResponse struct {
	...
	InstructionId string `protobuf:"bytes,1,opt,name=instruction_id,json=instructionId,proto3" json:"instruction_id,omitempty"`
	// Type of the response; can be "message", "stream", "info_message", "info_stream", "error", "info", "varaible_values", "snapshot_taken", "snapshot_loaded", "slash_commands", "feedback_received", "conversation_title", "get_tool_validation", "code_execution_response", "assistant_message_edited", "status_message", "status_stream", "chat_model_set", "disable_interrupt", "enable_interrupt", "get_approval"
	Type string `protobuf:"bytes,2,opt,name=type,proto3" json:"type,omitempty"`
	...
	StreamInterruptionAllowed bool `protobuf:"varint,19,opt,name=stream_interruption_allowed,json=streamInterruptionAllowed,proto3" json:"stream_interruption_allowed,omitempty"`
	// Approval properties
	ApprovalText    string   `protobuf:"bytes,20,opt,name=approval_text,json=approvalText,proto3" json:"approval_text,omitempty"`
	ApprovalOptions []string `protobuf:"bytes,21,rep,name=approval_options,json=approvalOptions,proto3" json:"approval_options,omitempty"`
	unknownFields   protoimpl.UnknownFields
	sizeCache       protoimpl.SizeCache
}
...
func (x *ClientResponse) GetToolCall() *ToolCall {
	if x != nil {
		return x.ToolCall
	}
	return nil
...
func (x *ClientResponse) GetStreamInterruptionAllowed() bool {
	if x != nil {
		return x.StreamInterruptionAllowed
	}
	return false
}

func (x *ClientResponse) GetApprovalText() string {
	if x != nil {
...
func (x *ClientResponse) GetApprovalOptions() []string {
	if x != nil {
...
// ToolCall is the message to send a tool call to the client.
type ToolCall struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// Identifier of the tool to be called
...
const file_pkg_aaliagentgrpc_aali_agent_proto_rawDesc = "" +
	...
	"\rapproval_text\x18\x14 \x01(\tR\fapprovalText\x12)\n" +
	"\x10approval_options\x18\x15 \x03(\tR\x0fapprovalOptions\x1aA\n" +
	"\x13VariableValuesEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
