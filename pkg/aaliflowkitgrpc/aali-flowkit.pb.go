...
type FunctionInputs struct {
	...
	ApprovalResponse string `protobuf:"bytes,5,opt,name=approval_response,json=approvalResponse,proto3" json:"approval_response,omitempty"`
	unknownFields    protoimpl.UnknownFields
	sizeCache        protoimpl.SizeCache
}
...
func (x *FunctionInputs) GetType() string {
	if x != nil {
		return x.Type
	}
	return ""
...
func (x *FunctionInputs) GetInstructionId() string {
	if x != nil {
...
func (x *FunctionInputs) GetApprovalResponse() string {
	if x != nil {
...
type FunctionOutputs struct {
	...
	ApprovalText string `protobuf:"bytes,6,opt,name=approval_text,json=approvalText,proto3" json:"approval_text,omitempty"`
	// Optional approval options only relevant for "get_approval" type; add "free_text" to allow free text input from the client.
	ApprovalOptions []string `protobuf:"bytes,7,rep,name=approval_options,json=approvalOptions,proto3" json:"approval_options,omitempty"`
	unknownFields   protoimpl.UnknownFields
	sizeCache       protoimpl.SizeCache
}
...
func (x *FunctionOutputs) GetMessage() string {
	if x != nil {
		return x.Message
	}
	return ""
...
func (x *FunctionOutputs) GetInstructionId() string {
	if x != nil {
		return x.InstructionId
	}
	return ""
...
func (x *FunctionOutputs) GetApprovalText() string {
	if x != nil {
		return x.ApprovalText
	}
	return ""
}

func (x *FunctionOutputs) GetApprovalOptions() []string {
	if x != nil {
		return x.ApprovalOptions
	}
	return nil
}
...
func (x *StreamInput) GetInputs() []*FunctionInput {
	if x != nil {
		return x.Inputs
	}
	return nil
...
const file_pkg_aaliflowkitgrpc_aali_flowkit_proto_rawDesc = "" +
	...
	"\rapproval_text\x18\x06 \x01(\tR\fapprovalText\x12)\n" +
	"\x10approval_options\x18\a \x03(\tR\x0fapprovalOptions\"|\n" +
