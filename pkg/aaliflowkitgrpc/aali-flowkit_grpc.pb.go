...
func (c *externalFunctionsClient) HealthCheck(ctx context.Context, in *HealthRequest, opts ...grpc.CallOption) (*HealthResponse, error) {
	...
	err := c.cc.Invoke(ctx, ExternalFunctions_HealthCheck_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *externalFunctionsClient) GetVersion(ctx context.Context, in *VersionRequest, opts ...grpc.CallOption) (*VersionResponse, error) {
	...
	err := c.cc.Invoke(ctx, ExternalFunctions_GetVersion_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *externalFunctionsClient) RunFunction(ctx context.Context, in *FunctionInputs, opts ...grpc.CallOption) (*FunctionOutputs, error) {
	...
	err := c.cc.Invoke(ctx, ExternalFunctions_RunFunction_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *externalFunctionsClient) StreamFunction(ctx context.Context, in *FunctionInputs, opts ...grpc.CallOption) (ExternalFunctions_StreamFunctionClient, error) {
	stream, err := c.cc.NewStream(ctx, &ExternalFunctions_ServiceDesc.Streams[0], ExternalFunctions_StreamFunction_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
...
func _ExternalFunctions_StreamFunction_Handler(srv interface{}, stream grpc.ServerStream) error {
	...
	return srv.(ExternalFunctionsServer).StreamFunction(m, &externalFunctionsStreamFunctionServer{stream})
}
